...
class Nave(models.Model):
    ...
    eslora_m = models.DecimalField(max_digits=5, decimal_places=2, validators=[MinValueValidator(1)])
    anio = models.PositiveIntegerField(validators=[MinValueValidator(1950)])
    armador = models.ForeignKey(Armador, on_delete=models.PROTECT, related_name="nave")
